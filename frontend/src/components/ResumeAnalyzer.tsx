...
export default function ResumeAnalyzer() {
    ...
    const handleAnalyze = async () => {
        ...
        try {
            ...
            // 1. Persist result for the Editor
            localStorage.setItem("optimized_resume", JSON.stringify({
                job_id: data.job_id,
                tex_source: data.tex_source,
            ...
            // 2. Short delay for "Success" feedback, then redirect
            setTimeout(() => {
